            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  Video düzenleme bilgisine ihtiyaç duymadan sınırsız sayıda <span className="text-cyan-500">benzersiz</span> video oluşturun ve sosyal medyadan para kazanmaya başlayın. 
                ...
                <div className="flex flex-col items-center justify-center space-y-4">
                  ...
                  <div className="flex flex-row items-center justify-center space-x-4 w-full max-w-md">
                    <button
                      onClick={() => window.open('https://forum.ve3.plus/?language=tr', '_blank')}
